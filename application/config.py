...
class ConfigService:
    ...
    def get_options(self) -> dict:
        ...
        return {
            ...
            "proxy_providers": self.provider_definitions.list_definitions("proxy", enabled_only=True),
            ...
            "proxy_drivers": self.provider_definitions.list_driver_templates("proxy"),
            ...
            "proxy_settings": self.provider_settings.list_settings("proxy"),
            **platform_options,
        }
