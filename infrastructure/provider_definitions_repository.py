...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    {
        "provider_type": "mailbox",
        "provider_key": "gmail_oauth_fission",
        "label": "Gmail OAuth（别名裂变）",
        "description": "使用一个已授权 Gmail 主号生成 plus/dot 别名，并通过 Gmail API 读取验证码",
        "driver_type": "gmail_oauth_fission",
        "default_auth_mode": "oauth",
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "oauth", "label": "OAuth"}],
        "fields": [
            {"key": "gmail_oauth_master_email", "label": "Gmail 主邮箱", "placeholder": "your@gmail.com", "category": "identity"},
            {"key": "gmail_oauth_fission_enable", "label": "开启裂变", "type": "toggle", "default_value": "true", "category": "identity"},
            {
                "key": "gmail_oauth_fission_mode",
                "label": "裂变模式",
                "type": "select",
                "default_value": "suffix",
                "category": "identity",
                "options": [
                    {"value": "suffix", "label": "plus 后缀"},
                    {"value": "dot", "label": "点号变体"},
                ],
            },
            {
                "key": "gmail_oauth_suffix_mode",
                "label": "后缀生成模式",
                "type": "select",
                ...
                "options": [
                    ...
                    {"value": "range", "label": "随机长度"},
                    {"value": "mystic", "label": "拟真词库"},
                ],
            },
            {"key": "gmail_oauth_suffix_len_min", "label": "后缀最小长度", "placeholder": "8", "default_value": "8", "category": "identity"},
            {"key": "gmail_oauth_suffix_len_max", "label": "后缀最大长度", "placeholder": "12", "default_value": "12", "category": "identity"},
            {"key": "gmail_oauth_mailbox_proxy", "label": "邮箱代理（可选）", "placeholder": "http://127.0.0.1:7890", "category": "connection"},
            {
                "key": "gmail_oauth_pool_json",
                "label": "Gmail 母号池 JSON（可选）",
                "type": "textarea",
                "category": "auth",
                "hint": "填写后优先使用母号池；每个母号一组 master_email、credentials_json、token_json，可选 aliases 手动子号数组，aliases 最多 5 个。",
                "placeholder": "[{\"master_email\":\"a@gmail.com\",\"credentials_json\":{},\"token_json\":{},\"aliases\":[\"a+001@gmail.com\"]}]",
            },
            {
                "key": "gmail_oauth_credentials_json",
                "label": "Google OAuth credentials.json",
                "type": "textarea",
                "secret": True,
                "category": "auth",
                "hint": "从 Google Cloud OAuth Client 下载的 JSON；填写后点击下方生成授权链接。",
            },
            {
                ...
                "secret": True,
                "category": "auth",
                "hint": "通过授权码换取后自动填入；也可手动粘贴已有 token JSON。",
            },
        ],
    },
    {
        ...
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "apikey", "label": "接码链接"}],
        "fields": [
            {
    ...
    },
    {
        ...
        "label": "iCloud 隐私邮箱（HME）",
        "description": "管理 iCloud 账号和 Hide My Email 隐私邮箱别名，通过 iCloud Cookie 创建别名并可用 App 专用密码收信",
        "driver_type": "icloud_hme",
        "default_auth_mode": "cookie",
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "cookie", "label": "Cookie / App Password"}],
        "fields": [
            {
                "key": "icloud_hme_accounts_json",
                "label": "iCloud 账号列表 JSON",
                "type": "textarea",
                "category": "auth",
                "secret": True,
                "hint": "通常无需手写，请使用下方账号列表管理。Cookie 可从 icloud.com 或 icloud.com.cn 浏览器请求中复制。",
            },
            {
                "key": "icloud_hme_label_prefix",
                "label": "新建别名标签前缀",
                "placeholder": "GeniusFKoai",
                "default_value": "GeniusFKoai",
                "category": "identity",
            },
            {
                "key": "icloud_hme_poll_interval",
                "label": "收信轮询间隔秒",
                "placeholder": "5",
                "default_value": "5",
                "category": "query",
            ...
            {
                "key": "icloud_hme_proxy",
                "label": "iCloud 请求代理（可选）",
                "placeholder": "http://127.0.0.1:7890",
                "category": "connection",
            },
        ],
    },
    {
        ...
        "fields": [
            ...
            {
                "key": "outlook_email_group_id",
                "label": "邮箱分组（可选）",
                "type": "async-select",
                "asyncUrl": "/provider-settings/outlook-email/groups",
                "asyncMethod": "POST",
                "asyncValueKey": "value",
                "asyncLabelKey": "label",
                "placeholder": "不限制分组",
                "category": "selection",
                "hint": "从 outlookEmail 服务自动读取分组；留空表示不按分组过滤",
            },
    ...
    },
    {
        ...
        "label": "GrizzlySMS",
        "description": "GrizzlySMS SMS provider, compatible with SMS-Activate style APIs.",
        ...
        "fields": [
            ...
            {"key": "grizzlysms_default_country", "label": "\u9ed8\u8ba4\u56fd\u5bb6", "type": "async-select", "asyncUrl": "/sms/grizzlysms/countries", "asyncValueKey": "id", "asyncLabelKey": "chn", "placeholder": "\u8bf7\u9009\u62e9\u56fd\u5bb6..."},
            {"key": "grizzlysms_default_service", "label": "\u9ed8\u8ba4\u670d\u52a1", "type": "async-select", "asyncUrl": "/sms/grizzlysms/services", "asyncValueKey": "code", "asyncLabelKey": "name", "placeholder": "\u8bf7\u9009\u62e9\u670d\u52a1..."},
            {"key": "grizzlysms_max_price", "label": "\u6700\u5927\u4ef7\u683c(\u53ef\u9009)", "placeholder": "-1"},
            {"key": "grizzlysms_auto_country", "label": "\u81ea\u52a8\u9009\u62e9\u6700\u4f18\u56fd\u5bb6", "type": "toggle", "hint": "\u542f\u7528\u540e\u5ffd\u7565\u9ed8\u8ba4\u56fd\u5bb6\uff0c\u81ea\u52a8\u9009\u62e9\u4ef7\u683c\u6700\u4f4e\u4e14\u5e93\u5b58\u5145\u8db3\u7684\u56fd\u5bb6"},
            {"key": "grizzlysms_base_url", "label": "Base URL", "placeholder": "https://api.grizzlysms.com/stubs/handler_api.php"},
            {"key": "register_phone_extra_max", "label": "\u53f7\u7801\u590d\u7528\u989d\u5916\u4e0a\u9650", "placeholder": "3"},
            {"key": "register_reuse_phone_to_max", "label": "\u590d\u7528\u53f7\u7801\u81f3\u6700\u5927", "type": "toggle"},
        ],
    },
    {
        "provider_type": "sms",
        "provider_key": "sms_verification_number_api",
        "label": "SMS Verification Number",
        "description": "SMS Verification Number provider, compatible with SMS-Activate style APIs.",
        "driver_type": "sms_verification_number_api",
        "default_auth_mode": "apikey",
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "apikey", "label": "API Key"}],
        "fields": [
            {"key": "sms_verification_number_api_key", "label": "API Key", "secret": True, "category": "auth"},
            {"key": "sms_verification_number_default_country", "label": "\u9ed8\u8ba4\u56fd\u5bb6", "type": "async-select", "asyncUrl": "/sms/sms-verification-number/countries", "asyncValueKey": "id", "asyncLabelKey": "chn", "placeholder": "\u8bf7\u9009\u62e9\u56fd\u5bb6..."},
            {"key": "sms_verification_number_default_service", "label": "\u9ed8\u8ba4\u670d\u52a1", "type": "async-select", "asyncUrl": "/sms/sms-verification-number/services", "asyncValueKey": "code", "asyncLabelKey": "name", "placeholder": "\u8bf7\u9009\u62e9\u670d\u52a1..."},
            {"key": "sms_verification_number_max_price", "label": "\u6700\u5927\u4ef7\u683c(\u53ef\u9009)", "placeholder": "-1"},
            {"key": "sms_verification_number_auto_country", "label": "\u81ea\u52a8\u9009\u62e9\u6700\u4f18\u56fd\u5bb6", "type": "toggle", "hint": "\u542f\u7528\u540e\u5ffd\u7565\u9ed8\u8ba4\u56fd\u5bb6\uff0c\u81ea\u52a8\u9009\u62e9\u4ef7\u683c\u6700\u4f4e\u4e14\u5e93\u5b58\u5145\u8db3\u7684\u56fd\u5bb6"},
            {"key": "sms_verification_number_base_url", "label": "Base URL", "placeholder": "https://sms-verification-number.com/stubs/handler_api"},
            {"key": "register_phone_extra_max", "label": "\u53f7\u7801\u590d\u7528\u989d\u5916\u4e0a\u9650", "placeholder": "3"},
            {"key": "register_reuse_phone_to_max", "label": "\u590d\u7528\u53f7\u7801\u81f3\u6700\u5927", "type": "toggle"},
        ],
    },
    {
        ...
        "label": "SMSPool",
        "description": "SMSPool native API provider imported from GuJumpgate.",
        "driver_type": "smspool_api",
        "default_auth_mode": "apikey",
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "apikey", "label": "API Key"}],
        "fields": [
            {"key": "smspool_api_key", "label": "API Key", "secret": True, "category": "auth"},
            {"key": "smspool_default_country", "label": "\u9ed8\u8ba4\u56fd\u5bb6", "type": "async-select", "asyncUrl": "/sms/smspool/countries", "asyncValueKey": "id", "asyncLabelKey": "chn", "placeholder": "\u8bf7\u9009\u62e9\u56fd\u5bb6..."},
            {"key": "smspool_default_service", "label": "\u9ed8\u8ba4\u670d\u52a1", "type": "async-select", "asyncUrl": "/sms/smspool/services", "asyncValueKey": "code", "asyncLabelKey": "name", "placeholder": "\u8bf7\u9009\u62e9\u670d\u52a1..."},
            {"key": "smspool_max_price", "label": "\u6700\u5927\u4ef7\u683c(\u53ef\u9009)", "placeholder": "-1"},
            {"key": "smspool_base_url", "label": "Base URL", "placeholder": "https://api.smspool.net"},
            {"key": "smspool_compat_base_url", "label": "Compat Base URL", "placeholder": "https://api.smspool.net/stubs/handler_api.php?setting=smspool"},
            {"key": "sms_poll_interval", "label": "\u53d6\u7801\u8f6e\u8be2\u95f4\u9694(\u79d2)", "placeholder": "5"},
        ],
    },
    {
        "provider_type": "sms",
        "provider_key": "five_sim_api",
        "label": "5sim",
        "description": "5sim native API provider imported from GuJumpgate.",
        "driver_type": "five_sim_api",
        "default_auth_mode": "apikey",
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "apikey", "label": "API Key"}],
        "fields": [
            {"key": "five_sim_api_key", "label": "API Key", "secret": True, "category": "auth"},
            {"key": "five_sim_country", "label": "\u9ed8\u8ba4\u56fd\u5bb6", "type": "async-select", "asyncUrl": "/sms/five-sim/countries", "asyncValueKey": "id", "asyncLabelKey": "chn", "placeholder": "\u8bf7\u9009\u62e9\u56fd\u5bb6..."},
            {"key": "five_sim_product", "label": "\u9ed8\u8ba4\u670d\u52a1", "type": "async-select", "asyncUrl": "/sms/five-sim/services", "asyncValueKey": "code", "asyncLabelKey": "name", "placeholder": "\u8bf7\u9009\u62e9\u670d\u52a1..."},
            {"key": "five_sim_operator", "label": "\u8fd0\u8425\u5546", "placeholder": "any"},
            {"key": "five_sim_max_price", "label": "\u6700\u5927\u4ef7\u683c(\u53ef\u9009)", "placeholder": "-1"},
            {"key": "five_sim_reuse", "label": "\u5141\u8bb8\u590d\u7528\u53f7\u7801", "type": "toggle"},
            {"key": "five_sim_base_url", "label": "Base URL", "placeholder": "https://5sim.net"},
            {"key": "sms_poll_interval", "label": "\u53d6\u7801\u8f6e\u8be2\u95f4\u9694(\u79d2)", "placeholder": "5"},
        ],
    },
    {
        "provider_type": "sms",
        "provider_key": "nexsms_api",
        "label": "NexSMS",
        "description": "NexSMS native API provider imported from GuJumpgate.",
        "driver_type": "nexsms_api",
        "default_auth_mode": "apikey",
        "enabled": True,
        "category": "thirdparty",
        "auth_modes": [{"value": "apikey", "label": "API Key"}],
        "fields": [
            {"key": "nexsms_api_key", "label": "API Key", "secret": True, "category": "auth"},
            {"key": "nexsms_default_country", "label": "\u9ed8\u8ba4\u56fd\u5bb6", "type": "async-select", "asyncUrl": "/sms/nexsms/countries", "asyncValueKey": "id", "asyncLabelKey": "chn", "placeholder": "\u8bf7\u9009\u62e9\u56fd\u5bb6..."},
            {"key": "nexsms_default_service", "label": "\u9ed8\u8ba4\u670d\u52a1", "type": "async-select", "asyncUrl": "/sms/nexsms/services", "asyncValueKey": "code", "asyncLabelKey": "name", "placeholder": "\u8bf7\u9009\u62e9\u670d\u52a1..."},
            {"key": "nexsms_max_price", "label": "\u6700\u5927\u4ef7\u683c(\u53ef\u9009)", "placeholder": "-1"},
            {"key": "nexsms_base_url", "label": "Base URL", "placeholder": "https://api.nexsms.net"},
            {"key": "sms_poll_interval", "label": "\u53d6\u7801\u8f6e\u8be2\u95f4\u9694(\u79d2)", "placeholder": "5"},
        ],
    },
    {
    ...
    },
    {
        ...
        "provider_key": "clash",
        "label": "Clash 本机节点切换",
        "description": "通过 Clash 外部控制接口轮询切换策略组节点，并返回本机代理入口",
        "driver_type": "clash",
        "default_auth_mode": "token",
        "enabled": True,
        "category": "local",
        "auth_modes": [{"value": "token", "label": "Secret"}],
        "fields": [
            {
                "key": "clash_api_url",
                "label": "外部控制接口",
                ...
                "category": "connection",
                "hint": "填写 Clash external-controller 地址，不要追加 /proxies",
            },
            {
                "key": "clash_secret",
                "label": "Secret",
            ...
            },
            {
                ...
                "category": "connection",
                "hint": "注册流程实际使用的 HTTP/SOCKS 代理入口",
            },
            {
                "key": "clash_selector",
                "label": "策略组",
                "placeholder": "GLOBAL",
                "category": "selection",
                "hint": "留空或填错时会自动选择第一个可切换策略组",
            },
            {
                "key": "clash_allocation_mode",
                "label": "分配模式",
                "type": "select",
                "default_value": "rotate_selector",
                "category": "selection",
                "options": [
                    {"value": "rotate_selector", "label": "切换单入口策略组"},
                    {"value": "multi_port", "label": "多入口独立端口"},
                ],
                "hint": "多入口模式会为注册并发启动独立 Mihomo 子进程，不切换主 Clash 的 GLOBAL",
            },
            {
                "key": "clash_node_filter",
                "label": "节点排除关键字（可选）",
                "placeholder": "香港,TH,泰国",
                "category": "selection",
                "hint": "逗号或换行分隔；名称包含这些关键字的节点会被排除",
            },
            {
                "key": "clash_check_url",
                "label": "出口检测 URL",
            ...
            {
                "key": "clash_multi_port_controller_start",
                "label": "多入口控制端口起点",
                "placeholder": "9191",
                "default_value": "9191",
                "category": "selection",
            ...
            {
                "key": "clash_multi_port_core_path",
                "label": "Mihomo 内核路径（可选）",
                "placeholder": "C:\\Program Files\\Clash Verge\\verge-mihomo.exe",
                "category": "connection",
            },
            {
                "key": "clash_multi_port_source_config",
                "label": "Clash 源配置（可选）",
                "placeholder": "自动读取 Clash Verge clash-verge.yaml",
                "category": "connection",
            },
            {
                "key": "clash_multi_port_runtime_dir",
                "label": "多入口运行目录（可选）",
                "placeholder": "自动使用 Clash Verge\\codex-register",
                "category": "connection",
            },
        ],
    },
