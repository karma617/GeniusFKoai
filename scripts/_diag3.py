...
print('init: amt=' + amt + ' pmt=' + str(init.get('payment_method_types')))
...
print('approve: ' + str(ar.status_code) + ' body=' + ar.text[:200])
...
for i in range(15):
    ...
    if pr.status_code == 200:
        ...
        print('poll[' + str(i) + ']: sa=' + str(sa_state) + ' err=' + str(sa_err)[:100] + ' si=' + str(si_status) + ' pi=' + str(pi_status))
